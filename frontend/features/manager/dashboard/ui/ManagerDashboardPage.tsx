...
const isBatchRunningLong = (
  batch: ApiBatch,
  thresholdHours = LONG_RUNNING_THRESHOLD_HOURS,
) => {
...
export default function DashboardPage() {
  ...
  const batchByZoneData = (trend?.points ?? []).map((point) => ({
    zone:
      trendPeriod === "day" ? dayjs(point.date).format("DD/MM") : point.date,
  ...
  const hiddenUsedRecipes = hiddenRecipes.filter(
    (recipe) => recipe.batchCount > 0,
  );
      ...
      <div style={{ marginBottom: 24 }}>
        ...
        >
          <div>
            ...
            <Text type="secondary">
              Số liệu sản xuất và trạng thái thiết bị theo thời gian thực.
            </Text>
          </div>
          <Space wrap>
            <RangePicker
        ...
        <>
                ...
                >
                  <div>
                    ...
                    <Space style={{ marginTop: 8 }}>
                      ...
                      <Tag
                        color={failBatches > 0 ? "error" : "default"}
                        style={{ borderRadius: 20, border: "none" }}
                      >
          ...
          {managerAlerts.length > 0 && (
            <Card
              ...
              style={{ borderRadius: 7, marginBottom: 16 }}
            >
                  ...
                  {mtbfData.map((item, i) => (
                    <div key={i}>
                      ...
                      >
                        ...
                        >
                          <ThunderboltOutlined
                            style={{ fontSize: 20, color: item.progressColor }}
                          />
                        </div>
